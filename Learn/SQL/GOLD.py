...
img_dir = "C://Users//dbondarenko//PycharmProjects//pythonProject//Learn//SQL//test_images"
...
class App(customtkinter.CTk):
    ...
    def first_frame_writing_data(self):
        if len(self.first_frame_artikel_entry.get()) > 0:
            command_string = f"INSERT INTO Inventar (Artikel, Hersteller, Model, Seriennummer, Datum, Bemerkung) " \
                             ...
                             f"'{self.first_frame_model_entry.get().strip()}','{self.first_frame_sn_entry.get().strip()}'," \
    ...
    def open(self):
        ...
        subprocess.Popen(['start', fr"C:\Users\dbondarenko\PycharmProjects\pythonProject\Learn\SQL\{self.file_name}"],
                         shell=True)
